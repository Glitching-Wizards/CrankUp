...
namespace CrankUp
{
    ...
    {
        [Export] private string _nappulatScenePath = "res://game/level1/scenes/buttons.tscn";
        [Export] private string _sliderScenePath = "res://game/level1/scenes/slider.tscn";
        [Export] private string _conveyorScenePath = "res://game/level1/scenes/conveyor.tscn";
        [Export] private string _greenBScenePath = "res://game/level1/scenes/green_block.tscn";
        [Export] private string _yellowBScenePath = "res://game/level1/scenes/yellow_block.tscn";
        [Export] private string _rightConsolScenePath = "res://game/level1/scenes/right_consol.tscn";
        [Export] private string _leftConsolScenePath = "res://game/level1/scenes/left_consol.tscn";
