...
namespace CrankUp
{
    public partial class Levels : Node
    {
        ...
        private string _startLevelScenePath = "res://Menus/LevelStart/Scenes/StartLevel.tscn";
        ...
        public override void _Ready()
        {
            ...
            {
                GD.PrintErr("[ERROR] Button 'Level1' not found!");
            }
            else
            {
                GD.Print("[DEBUG] Level1 button found.");
